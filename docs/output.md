...
- `tables/`
  ...
  - `differential/`: Directory containing tables of differential statistics reported by differential modules such as DESeq2
    ...
    - `[contrast_name].[deseq2|dream|limma].annotated.tsv`: Results of annotated DESeq2 differential analyis (RNA-seq), DREAM differential analysis (RNA-seq or generic matrix for mixed linear models) OR Limma differential analysis (Affymetrix arrays, GEO studies, generic matrix studies)
