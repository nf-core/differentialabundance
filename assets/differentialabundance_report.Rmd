...
```{r, echo=FALSE, results='asis', fig.height=8, eval=(!is.null(params$features_biotype_col) & !is.null(params$features))}cat("### Number of differentially expressed genes by gene type")
