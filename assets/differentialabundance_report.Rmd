...
params:
  ...
  report_title: NULL,
  report_pi_name: NULL
  report_pi_email: NULL
  report_pi_address1: NULL
  report_pi_address2: NULL
  report_pi_address3: NULL
  report_pi_address4: NULL
  report_pi_address5: NULL
  report_pi_address6: NULL
  report_contact_name: NULL
  report_contact_email: NULL
  report_contact_address1: NULL
  report_contact_address2: NULL
  report_contact_address3: NULL
  report_contact_address4: NULL
  report_contact_address5: NULL
  report_contact_address6: NULL
  report_author: NULL,
...
if (!is.null(params$report_pi_name)) {
  cat(paste0("**Project Members**:  \n"))
  cat(paste0((params$report_pi_name)))
}
# Add further PI info only if name was provided
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_email))     { cat(paste0( "  \n", params$report_pi_email )) }
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_address1))  { cat(paste0( "  \n", params$report_pi_address1 )) }
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_address2))  { cat(paste0( "  \n", params$report_pi_address2 )) }
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_address3))  { cat(paste0( "  \n", params$report_pi_address3 )) }
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_address4))  { cat(paste0( "  \n", params$report_pi_address4 )) }
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_address5))  { cat(paste0( "  \n", params$report_pi_address5 )) }
if (!is.null(params$report_pi_name) & !is.null(params$report_pi_address6))  { cat(paste0( "  \n", params$report_pi_address6 )) }
if (!is.null(params$report_pi_name))                                        { cat(paste0( "<br><br>" )) }

if (!is.null(params$report_contact_name)) {
  cat(paste0("**Contact persons**:  \n"))
  cat(paste0((params$report_contact_name)))
}
# Add further contact info only if name was provided
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_email))     { cat(paste0( "  \n", params$report_contact_email )) }
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_address1))  { cat(paste0( "  \n", params$report_contact_address1 )) }
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_address2))  { cat(paste0( "  \n", params$report_contact_address2 )) }
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_address3))  { cat(paste0( "  \n", params$report_contact_address3 )) }
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_address4))  { cat(paste0( "  \n", params$report_contact_address4 )) }
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_address5))  { cat(paste0( "  \n", params$report_contact_address5 )) }
if (!is.null(params$report_contact_name) & !is.null(params$report_contact_address6))  { cat(paste0( "  \n", params$report_contact_address6 )) }
if (!is.null(params$report_contact_name))                                             { cat(paste0( "<br><br>" )) }
```
