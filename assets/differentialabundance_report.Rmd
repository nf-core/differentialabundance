...
pca_vs_meta <- anova_pca_metadata(pca_datas[['variance_stabilised']]$coords, observations[,informative_variables, drop = FALSE], pca_datas[['variance_stabilised']]$percentVar)
