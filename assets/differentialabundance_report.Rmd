...
round_dataframe_columns <- function(df, columns = NULL, digits = -1) {
    ...
    df[,columns] <- format(df[,columns], scientific=T, digits=params$report_round_digits)
