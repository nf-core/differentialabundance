...
params:
  ...
  logo: "assets/nf-core-differentialabundance_logo_light.png"
---
...
```{r, include=FALSE}
versions <- unlist(yaml.load_file(params$versions_file), recursive = FALSE)
```

---
title:  "<img src=\"nf-core-differentialabundance_logo_light.png\" style=\"float: left;\"/>Differential `r params$feature_type` abundance report"
