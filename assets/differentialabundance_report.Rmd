...
features_df <- rename(features_df, any_of(c(gene_id="PROBEID", gene_biotype="GENETYPE")))
assay_data_normalised <- assay_data_normalised %>% left_join(select(features_df, gene_id, gene_biotype), by="gene_id")
