...
### Differential `{r} params$meta$params$features_type` `{r} ifelse(is.null(params$meta$params$study_abundance_type) || params$meta$params$study_abundance_type == "", "abundance", params$meta$params$study_abundance_type)}`
...
foo <- lapply(names(p_value_types), function(pvt) {
    ...
    ifelse(is.null(params$meta$params$study_abundance_type) || params$meta$params$study_abundance_type == "", "abundance", params$meta$params$study_abundance_type),
