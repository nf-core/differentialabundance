...
process RMARKDOWNNOTEBOOK {
    ...
    conda "conda-forge::r-base=4.1.0 conda-forge::r-rmarkdown=2.9 conda-forge::r-yaml=2.2.1 anaconda::gmp=6.2.1 conda-forge::r-ggplot2=3.4.2"
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        ...
        'docker.io/library/pxnotebook_local' }"
