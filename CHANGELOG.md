...
- [[#73]](https://github.com/nf-core/differentialabundance/pull/73) - Make `--matrix`, `--input`, `--features` accept either CSV,TXT or TSV files as input, reported by [@apeltzer](https://github.com/apeltzer), review by [@pinin4fjords](https://github.com/pinin4fjords)
