...
- [[#478]](https://github.com/nf-core/differentialabundance/pull/478) - Added parameter to skip outlier detection section in report ([@SusiJo](https://github.com/SusiJo), review by [])
