...
- [[#648](https://github.com/nf-core/differentialabundance/pull/648) - Remove --differential_foldchanges_logged paramter and assume fold changes are always on the log scale ([@delfiterradas](https://github.com/delfiterradas), review by [@grst](https://github.com/grst) and [@pinin4fjords](https://github.com/pinin4fjords)).
