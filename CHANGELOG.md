...
- [[#XXX]](https://github.com/nf-core/differentialabundance/pull/XXX) - Added parameter to skip outlier detection section in report ([@SusiJo](https://github.com/SusiJo), review by [])
